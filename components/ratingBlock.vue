<template>
  <div class="relative w-full bg-gray-50 flex flex-col items-center py-2 md:py-6 lg:py-8 overflow-hidden">

    <div class="z-10 absolute bottom-[-25vw] md:bottom-[-20vw] blur-sm opacity-15 sm:opacity-10 w-[100vw] md:w-[90vw]">
...
<style>
.color-animate {
  animation: ch-color-1 ease-in-out 3s infinite;
}
