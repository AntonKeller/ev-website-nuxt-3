...
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderComponent } from 'vue/server-renderer';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-3845a79f><div class="customers-container" data-v-3845a79f><div class="customers-sub-container" data-v-3845a79f><div${ssrRenderAttrs(mergeProps({
    initial: { opacity: 0, scale: 0.85 },
    enter: { opacity: 1, scale: 1 },
    delay: 400
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-3845a79f><div class="customer-title" data-v-3845a79f> \u041E\u043F\u044B\u0442 \u043D\u0430\u0448\u0435\u0439 \u043A\u043E\u043C\u0430\u043D\u0434\u044B </div><div class="chips" data-v-3845a79f><!--[-->`);
  ssrRenderList($options.getGroups(), (group) => {
    _push(`<div class="${ssrRenderClass([{ "chip": !$options.isSelected(group.name), "chip-active": $options.isSelected(group.name) }, "duration-100"])}" data-v-3845a79f>${ssrInterpolate(group.name)} <i class="ml-1.5 text-xs pi pi-filter" data-v-3845a79f></i></div>`);
  });
  _push(`<!--]--></div></div><div${ssrRenderAttrs(mergeProps({
    ...
    enter: { opacity: 1, scale: 1 },
    delay: 600
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-3845a79f><!--[-->`);
  ssrRenderList($options.getCompaniesLogo(), (companyLogo) => {
    _push(`<img${ssrRenderAttr("src", `/assets/experience_logotypes/${companyLogo.img}.png`)} class="logo" alt="err" data-v-3845a79f>`);
  });
  _push(`<!--]--></div></div>`);
        ...
        ssrRenderList($options.getCompaniesLogo(), (companyLogo) => {
          _push2(ssrRenderComponent(_component_slide, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img class="slide-img"${ssrRenderAttr("src", `/assets/experience_logotypes/${companyLogo.img}.png`)} alt="err" data-v-3845a79f${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
                    class: "slide-img",
...
const experience = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-3845a79f"]]);

export { experience as default };
//# sourceMappingURL=experience-DO7z7MQS.mjs.map
