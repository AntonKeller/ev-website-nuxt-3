...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-a4018bc4><div class="directors-section" data-v-a4018bc4><div class="manager-section-title" data-v-a4018bc4><h2 class="text-gray-100 text-lg lg:text-2xl font-bold duration-300" data-v-a4018bc4> \u0421\u043E\u0441\u0442\u0430\u0432 \u0434\u0438\u0440\u0435\u043A\u0442\u043E\u0440\u043E\u0432 </h2><div class="text-base lg:text-lg font-light text-gray-700 duration-300 space-y-0.5 px-6 md:px-0" data-v-a4018bc4><div class="text-gray-200" data-v-a4018bc4>\u0411\u0435\u0437\u0443\u043F\u0440\u0435\u0447\u043D\u0430\u044F \u0440\u0435\u043F\u0443\u0442\u0430\u0446\u0438\u044F \u043D\u0430 \u0440\u044B\u043D\u043A\u0435 \u043A\u043E\u043D\u0441\u0443\u043B\u044C\u0442\u0430\u0446\u0438\u043E\u043D\u043D\u044B\u0445 \u0443\u0441\u043B\u0443\u0433 \u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 \u0431\u043E\u043B\u0435\u0435 12 \u043B\u0435\u0442</div></div></div><div class="flex flex-col justify-center gap-1 lg:gap-1 duration-300" data-v-a4018bc4><!--[-->`);
  ssrRenderList(_ctx.employees, (e) => {
    _push(`<div${ssrRenderAttrs(mergeProps({
      ...
      hovered: { scale: 1.2 },
      delay: (1 + e.id) * 200,
      duration: (1 + e.id) * 1200
    }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-a4018bc4><div class="card-img-desc-wrapper" data-v-a4018bc4><img class="card-image"${ssrRenderAttr("src", `/assets/avatars/${e.img}`)} alt="no img" data-v-a4018bc4><div class="card-img-desc" data-v-a4018bc4><div class="text-gray-900 font-extrabold" data-v-a4018bc4>${ssrInterpolate(e.fullName)}</div><div class="text-gray-800 font-medium text-xs" data-v-a4018bc4>${ssrInterpolate(e.post)}</div></div></div><div class="card-description" data-v-a4018bc4>${ssrInterpolate(e.text)}</div></div>`);
  });
  _push(`<!--]--></div></div>`);
...
const directors = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a4018bc4"]]);

export { directors as default };
//# sourceMappingURL=directors-1FI38Ogd.mjs.map
