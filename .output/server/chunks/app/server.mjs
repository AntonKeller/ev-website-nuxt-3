import { version, unref, inject, defineComponent, useSlots, reactive, h, computed, resolveComponent, onUpdated, ref, provide, createElementBlock, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, mergeProps, resolveDirective, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext, createApp, effectScope, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentInstance, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, getCurrentScope, onScopeDispose, onUnmounted } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as hasProtocol, j as joinURL, p as parseURL, m as parseQuery, n as createHooks, w as withQuery, o as isScriptProtocol, q as withTrailingSlash, r as withoutTrailingSlash, t as sanitizeStatusCode } from '../nitro/node-server.mjs';
...
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const layouts = {
  default: () => import('./_nuxt/default-mPIC2N90.mjs').then((m) => m.default || m)
};
...
const _imports_0 = "" + __publicAssetsURL("assets/logotypes/ev-logotype-4-gray-light.png");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          ...
          createVNode("div", { class: "logoTitle text-base text-gray-100 font-semibold" }, "Everest home")
        ];
      }
    }),
    _: 1
  ...
  ssrRenderList(_ctx.links, (link) => {
    _push(ssrRenderComponent(_component_NuxtLink, {
      key: link.id,
      to: link.location,
      class: [{ "active": link.id === _ctx.activeID, "text-gray-100": link.id !== _ctx.activeID }, "active:scale-95 hovered rounded-md py-0.5 px-3 cursor-pointer hover:text-gray-400 duration-200"],
      onClick: ($event) => {
        _ctx.activeID = link.id;
        _ctx.menuVisible = false;
      }
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
  ...
  ssrRenderList(_ctx.links, (link) => {
    _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
      key: link.id,
      to: link.location,
      class: [{ "active": link.id === _ctx.activeID }, "hovered cursor-pointer text-gray-300 rounded-sm py-0.5 px-1 duration-100"],
      onClick: ($event) => {
        _ctx.activeID = link.id;
        _ctx.menuVisible = false;
      }
    }, ssrGetDirectiveProps(_ctx, _directive_motion_slide_visible_right)), {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(link.title)}`);
        } else {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-6v2Skvus.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-Dqp7iLRR.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-AWUNNVtG.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$1 as a, createError as c, entry$1 as default, evHeader as e, injectHead as i, resolveUnrefHeadInput as r };
